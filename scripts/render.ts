...
const MAIN_ACTION_HASH = "QmX2T24axEd6qkGf4BrnzPYMromGfxSc9zmgS5wGXGpcKm";
...
const main = async () => {
    ...
    // const renderActionCode = await fs.readFile(
    //     path.join(process.cwd(), 'renderer/dist', 'main.js'),
    //     'utf-8'
    // );
